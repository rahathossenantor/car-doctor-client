    ...
    return (
        <section id="banner">
            <div className="md:container md:mx-auto text-center banner-bg">
                <div className="w-full h-full 2xl:py-40 xl:py-36 lg:py-[100px] md:py-20 py-16 text-left flex items-center p-4 md:p-7 lg:p-8 xl:p-10 2xl:p-14 bg-gradient-to-r from-[#000000cc] to-[#00000066]">
